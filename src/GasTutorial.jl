...
Authors: HSWT/AI Simulation Development Group, 22/06/23.
"""
module GasTutorial
...
The populating agents in the GasTutorial model.
"""
...
Create and initialise the GasTutorial model.
"""
function gastutorial(;
...
This is the heart of the GasTutorial model: It calculates how Particles collide with each other,
...
Run a simulation of the GasTutorial model and init the UI.
"""
function run()
...
#	height = GLMakie.MonitorProperties(monitor).videomode.height # get height of monitor
	...
	playground,abmobs = abmplayground( model, gastutorial; # create playground
		agent_step!,
		model_step!,
		mdata,
		mlabels,
